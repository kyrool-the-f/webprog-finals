...
// Fetch cancelled orders from database
$sql = "SELECT form_id, full_name, email, status, contact_number, vehicle_type, assigned_car, service_type, pickup_location, pickup_datetime, return_location, return_datetime FROM orders_history WHERE status = 'Cancelled' ORDER BY form_id DESC";
...
<head>
    ...
    <title>Cancelled Orders — Car Rentals</title>
...
<body>
    ...
    <main class="admin-container">
        <header class="admin-header">
            ...
            <p>View all cancelled rental transactions.</p>
        </header>
        ...
        <div class="admin-wrapper">
            <aside class="sidebar">
                <h3>Filter</h3>
                <ul>
                    <li><a href="history.php">All Bookings</a></li>
                    <li><a href="completed.php">Completed</a></li>
                    <li><a href="cancelled.php" class="active">Cancelled</a></li>
                </ul>
            </aside>
                    ...
                    <table class="admin-table" data-table="orders_history">
                        ...
                        <tbody>
                            ...
                            if (count($bookings) > 0) {
                                ...
                                echo '<tr><td colspan="11" style="text-align: center; padding: 20px;">No cancelled orders found</td></tr>';
                            }
                            ?>
                        </tbody>
                    </table>
