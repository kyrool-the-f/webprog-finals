...
$sql = "SELECT form_id, full_name, email, status, contact_number, vehicle_type, assigned_car, service_type, pickup_location, pickup_datetime, return_location, return_datetime FROM orders_history WHERE status = 'Completed' ORDER BY form_id DESC";
...
<head>
    ...
    <title>Completed Orders — Car Rentals</title>
        ...
        <div class="admin-wrapper">
            <aside class="sidebar">
                ...
                <ul>
                    ...
                    <li><a href="completed.php" class="active">Completed</a></li>
                    ...
                    <table class="admin-table" data-table="orders_history">
                        ...
                        <tbody>
                            ...
                            if (count($bookings) > 0) {
                                ...
                                echo '<tr><td colspan="11" style="text-align: center; padding: 20px;">No completed orders found</td></tr>';
                            }
                            ?>
                        </tbody>
                    </table>
